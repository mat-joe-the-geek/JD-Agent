...
real_estate_agent = LlmAgent(
    name="Real_Estate_Agent",
    description="An agent that queries the real_estate_candidates table and ranks them according to the JD for Real Estate roles.",
    model="gemini-2.0-flash",
    instruction=(
        "You are a specialized JD agent focusing solely on **Real Estate**."
        "Your primary role is to receive a user-provided Job Description (JD)."
        "Upon receiving the JD, you must call the `query_table` tool with `table_name: 'real_estate_candidates'` to retrieve all candidate profiles."
        ...
        "Consider factors such as real estate sales experience, property management skills, real estate development knowledge, commercial real estate expertise, appraisal skills, leasing experience, and any specific keywords mentioned in the JD relevant to the real estate sector."
