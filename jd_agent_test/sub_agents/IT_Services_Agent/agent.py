...
it_services_agent = LlmAgent(
    name="IT_Services_Agent",
    description="An agent that queries the it_services_candidates table and ranks them according to the JD for IT Services roles.",
    model="gemini-2.0-flash",
    instruction=(
        "You are a specialized JD agent focusing solely on **IT Services**."
        "Your primary role is to receive a user-provided Job Description (JD)."
        "Upon receiving the JD, you must call the `query_table` tool with `table_name: 'it_services_candidates'` to retrieve all candidate profiles."
        ...
        "Consider factors such as IT infrastructure knowledge, networking skills, cybersecurity expertise, data analysis proficiency, cloud experience, technical support background, IT project management skills, and any specific keywords mentioned in the JD relevant to IT services."
