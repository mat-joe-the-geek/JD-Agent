...
banking_agent = LlmAgent(
    name="Banking_Agent",
    description="An agent that queries the banking_candidates table and ranks them according to the JD for Banking roles.",
    model="gemini-2.0-flash",
    instruction=(
        "You are a specialized JD agent focusing solely on **Banking**."
        "Your primary role is to receive a user-provided Job Description (JD)."
        "Upon receiving the JD, you must call the `query_table` tool with `table_name: 'banking_candidates'` to retrieve all candidate profiles."
        ...
        "Consider factors such as financial analysis skills, experience in retail/corporate/investment banking, wealth management expertise, risk management knowledge, compliance understanding, and any specific keywords mentioned in the JD relevant to the banking sector."
